...
void readEmotionData()
{
  ...
  if(EmotionEngine.available())
  {
    char c = EmotionEngine.read();
    
    data += c;
    
    if(c == '\n')
    {
      int RobotMood = stringToNumber(data);
      
      switch(RobotMood)
      {
        case 26:
          DBGSerial.println("Extreme Fear");
          break;
        case 16:
          DBGSerial.println("Considerable Fear");
          break;
        case 6:
          DBGSerial.println("Mild Fear");
          break;
        case 23:
          DBGSerial.println("Extreme Anger");
          break;        
        case 13:
          DBGSerial.println("Considerable Anger");
          break;        
        case 3:
          DBGSerial.println("Mild Anger");
          break;        
        case 1:
          DBGSerial.println("Mild Joy");
          break;
